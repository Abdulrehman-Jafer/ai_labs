...
export default function Register() {
    ...
    return (
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
            ...
            <p className="text-xs mt-4 text-[#002D74]">Please enter your info to sign up:</p>            
            <form onSubmit={handleRegister} className="flex flex-col gap-4">
                ...
                <button className="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">Submit</button>
                </form>
            ...
            <div className="md:block hidden w-1/2">
                <img className="rounded-2xl" src="https://images.unsplash.com/photo-1601524909109-10c0a85365ab?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80" />
            </div>
