export default async function handler(req, res) {
    ...
    const { vid_id, start_time, end_time, q } = req.query;
    ...
    try {
      ...
      const endpoint = `${process.env.NEXT_PRIVATE_BASE_URL}/search-yt-content?vid_id=${vid_id}&start_time=${start_time}&end_time=${end_time}&q=${q}`;
