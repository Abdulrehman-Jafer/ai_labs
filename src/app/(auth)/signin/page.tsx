        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:block hidden w-1/2">
            <img
              ...
              src="https://images.unsplash.com/photo-1570323085210-cc920ab3f50f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80"
            />
          </div>
        </div>
      </section>
